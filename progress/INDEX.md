...
|---|---|---|---|---|---|---|---|
| `in-progress` | FW Blog Roadmap | `progress/2026-07-27-fw-blog-roadmap/` | `site` | N/A | [fw-blog-roadmap-PROGRESS.md](_plans/fw-blog-roadmap-PROGRESS.md) | 2026-07-27 | 社群連結資料化（site.json social + 共用圖示 partial，關於我頁與全站頁尾）；tests 101/101；未 push |
